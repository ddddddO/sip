...
// TODO: Server setup/Client setup/Aggregate connected session は、sip.goファイル作って、そちらにまとめたい
func main() {
	// Server setup
	laddrUAS1 := "localhost:5061"
